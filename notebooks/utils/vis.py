...
def _get_colors():
    domain = ["Khodayari", "Millard", "Kurata", "iML1515", "ECC2", "Exp_iML1515", "Exp_ECC2", "Long"]
...
def jitter_summary_chart(norm_error, author=None, title=None, sort_list=None, opacity=False, color_scheme="category10"):
